...
namespace Projekt_SFML
{
    class ObjektTestowy : Object
    {
        ...
        public override void Start()
        {
            ...
            transform.scale = new Vector2f(0.3f, 0.3f);
        ...
        public override void Update()
        {
            ...
            {
                //transform.ChangeScale(new Vector2f(-0.0001f, -0.0001f) * (float)Program.DeltaTime);
